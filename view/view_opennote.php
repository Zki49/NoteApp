...
<head>
    ...
    transition: background-color 0.3s ease; /* Animation sur le changement de couleur de fond */
}
    ...
    <div class="container mt-4">
        <div class="row">
            <nav class="navbar">
                ...
                <a href="notes/pinned/<?= $notes->get_id()?>" class="styled-link-button"><?php
                           if($notes->pinned()){
                    ...
                    <div class="row">
                     ...
                     if(isset($deleted)&&$deleted){
                        ...
                        <dialog open>
                         ...
                         echo" </p>
                          <form method='dialog'>
                          <a  class ='anchor-button'href='notes/delete/";
                          echo $notes->get_id();
                          echo"'>
                            OK
                            </a>
                            <button class='anchor-button'>CANCEL</button>
                          </form>
                        </dialog>
                      ";
                     }
